...
Java_com_photographercamera_core_photon_stack_MgcSpatialRgbMerger_nativeMerge(
    JNIEnv* env,
    jobject,
...
extern "C" JNIEXPORT jint JNICALL
Java_com_photographercamera_core_photon_stack_MgcSpatialRgbMerger_nativeConvertPlanarF16ToFixed16(
    JNIEnv* env,
    jobject,
    jobject buffer,
    jint sample_count) {
