...
jfloatArray Java_com_photographercamera_core_photon_raw_RawLegacyAutoExposureNativeBridge_nativeSolveSingleGridExposure(JNIEnv* env, jobject arg1, jlong handle, jfloatArray candidate_display_linear_rgb, jint width, jint height, jfloat minimum_exposure_ev, jfloat maximum_exposure_ev);
...
jboolean Java_com_photographercamera_photon_raw_DngHdrNetProfileGainTableNative_nativeGenerateGains(JNIEnv* env, jobject arg1, jfloatArray coefficients_array, jfloatArray model_input_array, jint input_width, jint input_height, jint input_channels, jint source_grid_width, jint source_grid_height, jint source_grid_depth, jint coefficient_count, jint output_grid_width, jint output_grid_height, jint point_count, jfloat hdr_ratio, jfloat source_to_short_gain, jfloat renderer_baseline_gain, jfloat render_min_gain, jfloat render_max_gain, jfloat render_max_gain_blend_threshold, jfloat min_table_gain, jfloat max_table_gain, jfloatArray guide_shifts_array, jfloatArray guide_slopes_array, jfloatArray acr_curve_array, jfloatArray dehaze_curve_array, jfloat post_exposure_gain, jfloatArray map_input_weights_array, jfloatArray output_gains_array) {
  return Java_com_photographercamera_core_photon_raw_DngHdrNetProfileGainTableNative_nativeGenerateGains(env, arg1, coefficients_array, model_input_array, input_width, input_height, input_channels, source_grid_width, source_grid_height, source_grid_depth, coefficient_count, output_grid_width, output_grid_height, point_count, hdr_ratio, source_to_short_gain, renderer_baseline_gain, render_min_gain, render_max_gain, render_max_gain_blend_threshold, min_table_gain, max_table_gain, guide_shifts_array, guide_slopes_array, acr_curve_array, dehaze_curve_array, post_exposure_gain, map_input_weights_array, output_gains_array);
}
...
jfloatArray Java_com_photographercamera_photon_raw_RawLegacyAutoExposureNativeBridge_nativeSolveSingleGridExposure(JNIEnv* env, jobject arg1, jlong handle, jfloatArray candidate_display_linear_rgb, jint width, jint height, jfloat minimum_exposure_ev, jfloat maximum_exposure_ev) {
  return Java_com_photographercamera_core_photon_raw_RawLegacyAutoExposureNativeBridge_nativeSolveSingleGridExposure(env, arg1, handle, candidate_display_linear_rgb, width, height, minimum_exposure_ev, maximum_exposure_ev);
}
