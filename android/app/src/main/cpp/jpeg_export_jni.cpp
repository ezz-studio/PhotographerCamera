...
Java_com_photographercamera_core_photon_gallery_Jpeg444ExportEncoder_writeNative(
...
extern "C" JNIEXPORT jboolean JNICALL
Java_com_photographercamera_core_photon_gallery_Jpeg444ExportEncoder_encodeGainmapNative(
    JNIEnv *env, jobject /* this */, jobject bitmap, jstring outputPath,
    jint quality) {
  if (!bitmap || !outputPath) {
...
extern "C" JNIEXPORT jboolean JNICALL
Java_com_photographercamera_core_photon_gallery_Jpeg444ExportEncoder_packageJpegRNative(
...
extern "C" JNIEXPORT jboolean JNICALL
Java_com_photographercamera_core_photon_gallery_Jpeg444ExportEncoder_isJpegRNative(
