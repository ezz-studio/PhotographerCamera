...
Java_com_photographercamera_core_photon_color_LutProcessor_resampleLutNative(
...
extern "C" JNIEXPORT jshortArray JNICALL
Java_com_photographercamera_core_photon_color_LutProcessor_resampleSizeNative(
