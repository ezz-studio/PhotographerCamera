...
import com.photographercamera.photon.lut.ChromaDenoiseAlgorithm
import com.photographercamera.photon.ml.SharedDepthEstimator
import com.photographercamera.photon.processor.GlesGpuCompletion
import com.photographercamera.photon.processor.GlesGpuScheduler
...
import com.photographercamera.photon.processor.GlesPixelBufferTransfer
...
import com.photographercamera.photon.processor.GpuStackCompletionTimeline
import com.photographercamera.photon.processor.RawNoiseModel
import com.photographercamera.photon.processor.RawStackResult
import com.photographercamera.photon.utils.DirectBufferPixelPacker
...
class RawDemosaicProcessor {
    ...
    private fun obtainReadbackBuffer(pixelSize: Int): ByteBuffer {
        ...
        releaseReadbackBuffer()
        return (com.photographercamera.photon.utils.DirectBufferAllocator.allocateNative(pixelSize.toLong())
            ?.order(ByteOrder.nativeOrder())
    ...
    private fun releaseReadbackBuffer() {
        readbackBuffer?.let { com.photographercamera.photon.utils.DirectBufferAllocator.freeNative(it) }
        readbackBuffer = null
