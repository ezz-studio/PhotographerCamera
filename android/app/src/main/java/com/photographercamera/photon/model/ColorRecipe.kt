...
enum class RecipeParam(
    ...
    EXPOSURE(com.photographercamera.R.string.recipe_param_exposure, -2.0f, 2.0f, 0f),
    CONTRAST(com.photographercamera.R.string.recipe_param_contrast, 0.5f, 1.5f, 1f),
    SATURATION(com.photographercamera.R.string.recipe_param_saturation, 0.0f, 2.0f, 1f),
    TEMPERATURE(com.photographercamera.R.string.recipe_param_temperature, -1.0f, 1.0f, 0f),
    TINT(com.photographercamera.R.string.recipe_param_tint, -1.0f, 1.0f, 0f),
    FADE(com.photographercamera.R.string.recipe_param_fade, 0.0f, 1.0f, 0f),
    COLOR(com.photographercamera.R.string.recipe_param_color, -1.0f, 1.0f, 0f),
    HIGHLIGHTS(com.photographercamera.R.string.recipe_param_highlights, -1.0f, 1.0f, 0f),
    SHADOWS(com.photographercamera.R.string.recipe_param_shadows, -1.0f, 1.0f, 0f),
    FILM_GRAIN(com.photographercamera.R.string.recipe_param_film_grain, 0.0f, 1.0f, 0f),
    VIGNETTE(com.photographercamera.R.string.recipe_param_vignette, -1.0f, 1.0f, 0f),
    FLASH(com.photographercamera.R.string.recipe_param_flash, 0.0f, 1.0f, 0f),
    BLEACH_BYPASS(com.photographercamera.R.string.recipe_param_bleach_bypass, 0.0f, 1.0f, 0f),
    CLARITY(com.photographercamera.R.string.recipe_param_clarity, -1.0f, 1.0f, 0f),
    SHARPNESS(com.photographercamera.R.string.recipe_param_sharpness, -1.0f, 1.0f, 0f),
    BLOOM(com.photographercamera.R.string.recipe_param_bloom, 0.0f, 1.0f, 0f),
    SOFT_LIGHT(com.photographercamera.R.string.recipe_param_soft_light, 0.0f, 1.0f, 0f),
    HDF(com.photographercamera.R.string.recipe_param_hdf, 0.0f, 1.0f, 0f),
    HALATION(com.photographercamera.R.string.recipe_param_halation, 0.0f, 1.0f, 0f),
    CHROMATIC_ABERRATION(com.photographercamera.R.string.recipe_param_chromatic_aberration, 0.0f, 1.0f, 0f),
    NOISE(com.photographercamera.R.string.recipe_param_noise, 0.0f, 1.0f, 0f),
    LOW_RES(com.photographercamera.R.string.recipe_param_low_res, 0.0f, 1.0f, 0f),
    SKIN_HUE(com.photographercamera.R.string.recipe_param_skin_hue, -1.0f, 1.0f, 0f),
    SKIN_CHROMA(com.photographercamera.R.string.recipe_param_skin_chroma, -1.0f, 1.0f, 0f),
    SKIN_LIGHTNESS(com.photographercamera.R.string.recipe_param_skin_lightness, -1.0f, 1.0f, 0f),
    RED_HUE(com.photographercamera.R.string.recipe_param_red_hue, -1.0f, 1.0f, 0f),
    RED_CHROMA(com.photographercamera.R.string.recipe_param_red_chroma, -1.0f, 1.0f, 0f),
    RED_LIGHTNESS(com.photographercamera.R.string.recipe_param_red_lightness, -1.0f, 1.0f, 0f),
    ORANGE_HUE(com.photographercamera.R.string.recipe_param_orange_hue, -1.0f, 1.0f, 0f),
    ORANGE_CHROMA(com.photographercamera.R.string.recipe_param_orange_chroma, -1.0f, 1.0f, 0f),
    ORANGE_LIGHTNESS(com.photographercamera.R.string.recipe_param_orange_lightness, -1.0f, 1.0f, 0f),
    YELLOW_HUE(com.photographercamera.R.string.recipe_param_yellow_hue, -1.0f, 1.0f, 0f),
    YELLOW_CHROMA(com.photographercamera.R.string.recipe_param_yellow_chroma, -1.0f, 1.0f, 0f),
    YELLOW_LIGHTNESS(com.photographercamera.R.string.recipe_param_yellow_lightness, -1.0f, 1.0f, 0f),
    GREEN_HUE(com.photographercamera.R.string.recipe_param_green_hue, -1.0f, 1.0f, 0f),
    GREEN_CHROMA(com.photographercamera.R.string.recipe_param_green_chroma, -1.0f, 1.0f, 0f),
    GREEN_LIGHTNESS(com.photographercamera.R.string.recipe_param_green_lightness, -1.0f, 1.0f, 0f),
    CYAN_HUE(com.photographercamera.R.string.recipe_param_cyan_hue, -1.0f, 1.0f, 0f),
    CYAN_CHROMA(com.photographercamera.R.string.recipe_param_cyan_chroma, -1.0f, 1.0f, 0f),
    CYAN_LIGHTNESS(com.photographercamera.R.string.recipe_param_cyan_lightness, -1.0f, 1.0f, 0f),
    BLUE_HUE(com.photographercamera.R.string.recipe_param_blue_hue, -1.0f, 1.0f, 0f),
    BLUE_CHROMA(com.photographercamera.R.string.recipe_param_blue_chroma, -1.0f, 1.0f, 0f),
    BLUE_LIGHTNESS(com.photographercamera.R.string.recipe_param_blue_lightness, -1.0f, 1.0f, 0f),
    PURPLE_HUE(com.photographercamera.R.string.recipe_param_purple_hue, -1.0f, 1.0f, 0f),
    PURPLE_CHROMA(com.photographercamera.R.string.recipe_param_purple_chroma, -1.0f, 1.0f, 0f),
    PURPLE_LIGHTNESS(com.photographercamera.R.string.recipe_param_purple_lightness, -1.0f, 1.0f, 0f),
    MAGENTA_HUE(com.photographercamera.R.string.recipe_param_magenta_hue, -1.0f, 1.0f, 0f),
    MAGENTA_CHROMA(com.photographercamera.R.string.recipe_param_magenta_chroma, -1.0f, 1.0f, 0f),
    MAGENTA_LIGHTNESS(com.photographercamera.R.string.recipe_param_magenta_lightness, -1.0f, 1.0f, 0f),
    PRIMARY_RED_HUE(com.photographercamera.R.string.recipe_param_primary_red_hue, -1.0f, 1.0f, 0f),
    PRIMARY_RED_SATURATION(com.photographercamera.R.string.recipe_param_primary_red_saturation, -1.0f, 1.0f, 0f),
    PRIMARY_RED_LIGHTNESS(com.photographercamera.R.string.recipe_param_primary_red_lightness, -1.0f, 1.0f, 0f),
    PRIMARY_GREEN_HUE(com.photographercamera.R.string.recipe_param_primary_green_hue, -1.0f, 1.0f, 0f),
    PRIMARY_GREEN_SATURATION(com.photographercamera.R.string.recipe_param_primary_green_saturation, -1.0f, 1.0f, 0f),
    PRIMARY_GREEN_LIGHTNESS(com.photographercamera.R.string.recipe_param_primary_green_lightness, -1.0f, 1.0f, 0f),
    PRIMARY_BLUE_HUE(com.photographercamera.R.string.recipe_param_primary_blue_hue, -1.0f, 1.0f, 0f),
    PRIMARY_BLUE_SATURATION(com.photographercamera.R.string.recipe_param_primary_blue_saturation, -1.0f, 1.0f, 0f),
    PRIMARY_BLUE_LIGHTNESS(com.photographercamera.R.string.recipe_param_primary_blue_lightness, -1.0f, 1.0f, 0f),
    LUT_INTENSITY(com.photographercamera.R.string.recipe_param_lut_intensity, 0.0f, 1.0f, 1f);
