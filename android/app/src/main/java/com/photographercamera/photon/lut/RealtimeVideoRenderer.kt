...
import com.photographercamera.photon.video.VideoEncoderColorConfig
import com.photographercamera.photon.video.VideoEncodedColorPipeline
...
class RealtimeVideoRenderer(
    ...
    private fun drawLayer(
        ...
        GLES30.glUniform1i(
            ...
            LutShaderMappings.colorSpaceId(
                layer.lutConfig?.colorSpace ?: com.photographercamera.photon.raw.ColorSpace.SRGB
            ),
        )
        GLES30.glUniform1i(
    ...
    private fun bindRecipeUniforms(
        ...
        GLES30.glUniform1f(
            locations.uGrainSizeLocation,
            com.photographercamera.core.photon.color.FilmParamsStore.current.grainSize,
        )
        GLES30.glUniform1f(
            locations.uGrainDensityLocation,
            com.photographercamera.core.photon.color.FilmParamsStore.current.grainDensity,
        )
