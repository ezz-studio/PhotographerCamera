...
internal data class ColorPassLocations(
    ...
    val uGrainLumaContrastLocation: Int,
    val uGrainSizeLocation: Int,
    val uGrainDensityLocation: Int,
...
internal class PreviewColorProgramCache {
    ...
    private fun queryLocations(program: Int): ColorPassLocations {
        return ColorPassLocations(
            ...
            uGrainLumaContrastLocation = GLES30.glGetUniformLocation(program, "uGrainLumaContrast"),
            uGrainSizeLocation = GLES30.glGetUniformLocation(program, "uGrainSize"),
            uGrainDensityLocation = GLES30.glGetUniformLocation(program, "uGrainDensity"),
