...
import com.photographercamera.photon.processor.RawNoiseProfileSelection
    ...
    companion object {
        ...
        private val BUILT_IN_PROFILES = listOf(
            RawNoiseProfileInfo(
                ...
                filePath = null,
                isBuiltIn = true,
                nameResId = com.photographercamera.R.string.raw_noise_profile_system,
            ),
            RawNoiseProfileInfo(
                id = ADAPTIVE_PROFILE_ID,
                nameMap = emptyMap(),
                filePath = null,
                isBuiltIn = true,
                nameResId = com.photographercamera.R.string.raw_noise_profile_adaptive,
            ),
            RawNoiseProfileInfo(
                ...
                isBuiltIn = true,
                nameResId = com.photographercamera.R.string.raw_noise_profile_pixel8_pro,
            ),
            RawNoiseProfileInfo(
                ...
                isBuiltIn = true,
                nameResId = com.photographercamera.R.string.raw_noise_profile_x9_ultra,
            ),
            RawNoiseProfileInfo(
                ...
                isBuiltIn = true,
                nameResId = com.photographercamera.R.string.raw_noise_profile_x9_ultra_3x,
            ),
        )
    }
}
