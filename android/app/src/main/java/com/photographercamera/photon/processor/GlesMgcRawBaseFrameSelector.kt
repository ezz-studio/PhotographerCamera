...
internal data class GlesMgcRawBaseFrameSelection(
    ...
    val fastMomentsRawStats: com.photographercamera.photon.raw.RawSceneAERawStats? = null,
)
...
internal class GlesMgcRawBaseFrameSelector(
    ...
    private fun buildFastMomentsRawStats(frame: RawStackFrame):
        com.photographercamera.photon.raw.RawSceneAERawStats? {
            ...
            PLog.i(
                ...
                "Fast Moments GPU reference statistics size=${result.stats.width}x" +
                    ...
                    "baseRgb=${result.stats.baseFrameMetering?.let {
                        "${com.photographercamera.photon.raw.RawSceneExposureMath.INPUT_WIDTH}x" +
                            com.photographercamera.photon.raw.RawSceneExposureMath.INPUT_HEIGHT
