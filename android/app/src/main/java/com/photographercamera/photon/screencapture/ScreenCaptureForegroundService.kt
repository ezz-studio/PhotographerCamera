...
class ScreenCaptureForegroundService : Service() {
    ...
    private fun buildNotification(): Notification {
        return NotificationCompat.Builder(this, CHANNEL_ID)
            .setSmallIcon(com.photographercamera.R.mipmap.ic_launcher)
            .setContentTitle(getString(com.photographercamera.R.string.screen_capture_test_notification_title))
            .setContentText(getString(com.photographercamera.R.string.screen_capture_test_notification_text))
            .setOngoing(true)
    ...
    private fun createNotificationChannel() {
        ...
        val channel = NotificationChannel(
            CHANNEL_ID,
            getString(com.photographercamera.R.string.screen_capture_test_notification_channel),
