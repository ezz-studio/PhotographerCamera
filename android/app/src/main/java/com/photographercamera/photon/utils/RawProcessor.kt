...
import com.photographercamera.photon.raw.DngBaselineExposure
import com.photographercamera.photon.raw.DngProfileToneCurve
...
import com.photographercamera.photon.raw.RawPhysicalCrop
import com.photographercamera.photon.raw.RawNoiseProfileLayout
import com.photographercamera.photon.raw.RawRenderingEngine
import com.photographercamera.photon.raw.RawSceneExposureDeviceLimits
import com.photographercamera.photon.raw.RawWhiteLevelCorrection
import com.photographercamera.photon.raw.toAdobeDefaultMeteringPlan
import java.io.File
...
object RawProcessor {
    ...
    suspend fun prepareRawDngProfile(
        ...
        fastMomentsRawStats: com.photographercamera.photon.raw.RawSceneAERawStats? = null,
        width: Int,
        height: Int,
        characteristics: CameraCharacteristics,
        captureResult: CaptureResult,
        ...
        val captureProfile = options.captureProfilePreparer?.prepare(
            com.photographercamera.photon.raw.RawDngCaptureProfileInput(
        ...
        val viewfinderExposureOffsetEv = captureProfile?.exposureOffsetEv
            ?.takeIf { it.isFinite() }
            ?.coerceIn(
                com.photographercamera.photon.raw.MeteringSystem.RAW_EXPOSURE_MIN_EV,
                com.photographercamera.photon.raw.MeteringSystem.RAW_EXPOSURE_MAX_EV,
            )
