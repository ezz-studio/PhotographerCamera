...
import com.photographercamera.core.photon.video.VideoEncoderColorConfig
import com.photographercamera.core.photon.video.VideoEncodedColorPipeline
    ...
    private fun drawLayer(
        ...
        GLES30.glUniform1i(
            ...
            LutShaderMappings.colorSpaceId(
                layer.lutConfig?.colorSpace ?: com.photographercamera.core.photon.raw.ColorSpace.SRGB
            ),
        )
        GLES30.glUniform1i(
