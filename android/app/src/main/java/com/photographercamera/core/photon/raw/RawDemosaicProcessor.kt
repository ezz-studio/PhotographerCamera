...
import com.photographercamera.core.photon.data.ContentRepository
import com.photographercamera.core.photon.color.ChromaDenoiseAlgorithm
import com.photographercamera.core.photon.stack.GlesGpuCompletion
import com.photographercamera.core.photon.stack.GlesGpuScheduler
...
import com.photographercamera.core.photon.stack.GlesPixelBufferTransfer
import com.photographercamera.core.photon.stack.GpuBayerSource
...
import com.photographercamera.core.photon.stack.GpuLinearRgbStorage
import com.photographercamera.core.photon.stack.GpuStackCompletionTimeline
import com.photographercamera.core.photon.stack.RawNoiseModel
import com.photographercamera.core.photon.stack.RawStackResult
import com.photographercamera.core.photon.stack.DirectBufferPixelPacker
import com.photographercamera.core.photon.stack.LargeDirectBuffer
import com.photographercamera.core.photon.stack.PLog
import com.photographercamera.core.photon.stack.RawProcessor
...
class RawDemosaicProcessor {
    ...
    private fun obtainReadbackBuffer(pixelSize: Int): ByteBuffer {
        ...
        releaseReadbackBuffer()
        return (com.photographercamera.core.photon.stack.DirectBufferAllocator.allocateNative(pixelSize.toLong())
            ?.order(ByteOrder.nativeOrder())
    ...
    private fun releaseReadbackBuffer() {
        readbackBuffer?.let { com.photographercamera.core.photon.stack.DirectBufferAllocator.freeNative(it) }
        readbackBuffer = null
