...
import com.photographercamera.core.photon.livephoto.resolveLivePhotoRotationDegrees
...
class LutRenderer(context: Context) : GLSurfaceView.Renderer {
    ...
    @Volatile
    var baselineRecipeParams: com.photographercamera.core.photon.color.ColorRecipeParams =
        com.photographercamera.core.photon.color.ColorRecipeParams.DEFAULT
    ...
    private fun getColorPassLocations(
        ...
        lutConfig: LutConfig?,
        lutEnabled: Boolean,
        params: com.photographercamera.core.photon.color.ColorRecipeParams,
    ...
    private fun drawInternal(
        ...
        val layerParams = when {
            ...
            else -> com.photographercamera.core.photon.color.ColorRecipeParams.DEFAULT
        }
...
//            PLog.d(TAG, "LUT set: ${lutConfig.title}, size: ${lutConfig.size}")
    ...
    private fun renderMgcEisFrame(
        frame: com.photographercamera.core.photon.stabilization.StabilizationFrame,
...
//        PLog.d(TAG, "Update capture size: ${captureWidth}x${captureHeight}, totalRotation: $totalRotation")
     ...
     * 获取当前色彩配方参数对象
     */
    private fun getCurrentRecipeParams(): com.photographercamera.core.photon.color.ColorRecipeParams {
        return com.photographercamera.core.photon.color.ColorRecipeParams(
     ...
     */
    fun setRecipeParams(params: com.photographercamera.core.photon.color.ColorRecipeParams) {
    ...
    fun updateBaselineRecipeParams(params: com.photographercamera.core.photon.color.ColorRecipeParams) {
