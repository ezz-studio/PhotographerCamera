...
WEB_DIR = os.path.join(BUNDLE, "web") if getattr(sys, "frozen", False) else os.path.join(HERE, "web")
    ...
    def do_GET(self) -> None:  # noqa: N802
        ...
        try:
            ...
            if p == "/api/load_profile":
                ...
                # LUT profiles: params are the POST-LUT tuning layer; stale
                # inverse-solved params in old profiles would double-grade.
    ...
    def do_POST(self) -> None:  # noqa: N802
        ...
        try:
            ...
            if p == "/api/save":
                ...
                prof = S.safe_clamp(prof)
                _baked = R.bake_params_into_lut(prof)  # tuned params land in the LUT (Android parity)
